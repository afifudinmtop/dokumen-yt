...
(function (global, factory) {
  ...
  var Sizzle =
	...
	---------------------------------------------------------------------- */
        ...
        if ((support.qsa = rnative.test(document.querySelectorAll))) {
          ...
          assert(function (el) {
            ...
            // https://msdn.microsoft.com/id-ID/library/ie/hh465388.aspx#attribute_section
	...
	---------------------------------------------------------------------- */
      ...
      // https://msdn.microsoft.com/id-ID/library/ms536429%28VS.85%29.aspx
      if (
        !assert(function (el) {
  ...
  var // Swappable if display is none or starts with table
    ...
    // See here for display values: https://developer.mozilla.org/id-ID/docs/CSS/display
